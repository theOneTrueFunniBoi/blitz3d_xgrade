...
void Prefs::setDefault(){
    ...
    rgb_bkgrnd=RGB( 0x11,0x11,0x11 );
	rgb_string=RGB( 0xee,0xbb,0x44 );
	rgb_ident=RGB( 0xdd,0xdd,0xdd );
	rgb_keyword=RGB( 0x66,0xbb,0xee );
	rgb_comment=RGB( 0x00,0xcc,0x66 );
	rgb_digit=RGB( 0x99,0xee,0x99 );
	rgb_default=RGB( 0xcc,0xcc,0xcc );
